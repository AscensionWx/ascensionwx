...
#define SEND_INTERVAL_1000          900000      // Sleep for these many millis in between send()
#define SEND_INTERVAL_950           900000
#define SEND_INTERVAL_900           30000      
...
void send_observation() {
  ...
  float latitude = gps_latitude();
  float longitude = gps_longitude();
  float elevation_gps = gps_altitude();
  float elevation_2 =  get_elevation();
